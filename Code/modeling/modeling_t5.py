...
class T5Attention(nn.Module):
    def __init__(self, config: T5Config, has_relative_attention_bias=False):
        ...
        self.lamb = nn.Parameter(torch.zeros(self.n_heads), requires_grad=True)
    ...
    def forward(
        ...
        h=3
        high_order = (h-1) * (attn_weights @ attn_weights - attn_weights)
        high_order += attn_weights
        beta = self.lamb[None, :, None, None]
        attn_weights = attn_weights + beta * high_order
