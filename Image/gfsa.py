...
__all__ = [
    'gfsa_small_24', 'gfsa_small_12',
    'gfsa_base_24', 'gfsa_base_12'
]
...
@register_model
def gfsa_small_12(pretrained=False, **kwargs):
    print("Running GFSA small 12!!")
...
@register_model
def gfsa_small_24(pretrained=False, **kwargs):
    print("Running GFSA small 24!!")
    model = VisionTransformer(
        img_size=224, patch_size=16,
...
@register_model
def gfsa_base_12(pretrained=False, **kwargs):
    print("Running GFSA base 12!!")
    model = VisionTransformer(
        img_size=224, patch_size=16,
...
@register_model
def gfsa_base_24(pretrained=False, **kwargs):
    print("Running GFSA base 24!!")
    model = VisionTransformer(
        img_size=224, patch_size=16,
